        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="name" type="text" name="name"
                       ...
                       class="<?php echo e($errors->has('name') ? 'form-input-error' : 'form-input'); ?> pl-10"
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="email" type="email" name="email"
                       ...
                       class="<?php echo e($errors->has('email') ? 'form-input-error' : 'form-input'); ?> pl-10"
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="password" type="password" name="password"
                       placeholder="••••••••"
                       class="<?php echo e($errors->has('password') ? 'form-input-error' : 'form-input'); ?> pl-10"
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="password_confirmation" type="password" name="password_confirmation"
                       placeholder="••••••••"
                       class="<?php echo e($errors->has('password_confirmation') ? 'form-input-error' : 'form-input'); ?> pl-10"
                       required autocomplete="new-password">
            </div>
...
<?php endif; ?><?php /**PATH D:\L3GL\Semestre 1\Laravel\isi-burger\resources\views/auth/register.blade.php ENDPATH**/ ?>