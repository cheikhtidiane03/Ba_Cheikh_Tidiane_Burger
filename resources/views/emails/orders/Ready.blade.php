...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .ref { font-family:monospace; font-size:15px; font-weight:700; color:#2563eb;
               background:#eff6ff; border:1.5px solid #bfdbfe; padding:6px 14px;
        ...
        .total-row td { font-weight:800; color:#059669; font-size:15px; border:none; padding:12px 10px; }
        .pdf-note { background:#eff6ff; border:1.5px solid #bfdbfe; border-radius:10px;
                    padding:14px 16px; margin-bottom:16px; font-size:13px; color:#2563eb; line-height:1.5; }
...
<div class="wrapper">
    ...
    <div class="body">
        <div class="ready-badge">
            ...
            <p>Votre burger a été préparé avec soin</p>
        </div>
        ...
        <div class="pdf-note">
            📎 Votre <strong>facture PDF</strong> est jointe à cet email.<br>
            Merci de vous présenter au comptoir pour le paiement.
        </div>
    </div>
